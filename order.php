...
if( !empty($_SESSION['message'])){
  ...
  ?>
  <h1 style='color: green;'>SUCCESFULLY ORDERED!</h1>
...
$_SESSION['message'] = "";
         ...
         $query=mysqli_query($dbc, "SELECT pizzas.Name as Name, pizzas.PizzaId as PizzaId, pizzas.Price as Price, temp.TempId as TempId
                                    FROM temp
         ...
         $total = 0.0;
                ...
                <?php
                    ...
                    echo "<h5 class='card-title'>PIZZA NAME: " . $row['Name'] . "</h5>";
                    echo "<h5 class='card-title'>PRICE: " . $row['Price'] . " KM</h5>";
                    
                    echo "<a style='text-decoration:none;' class='card-button' href='deleteTempPizza.php?id=".$row['TempId']."'>DELETE</a>";
 ...
 ?>
                <hr style="margin-top: 500px !important; border-top: 1px solid #787878 !important;" />
                <div class="total" style="width: 190px;height: 65px;border:3px solid red;position: absolute;left: 663px;top: 500px;font-size: 22px;padding-top: 30px;"> <pre><?php echo "TOTAL AMOUNT:".$total; ?></pre></div>
                <a href="insertOrder.php"><div class="card-button" style="position: absolute;left: 850px;top: 495px;background-color: red;font-size: 20px;">SUBMIT</div></a>
